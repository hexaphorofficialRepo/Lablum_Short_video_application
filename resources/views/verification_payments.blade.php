...
<head>
    ...
    <title>Blue Tick/Official Account Verification Payment</title>
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-8 ">
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body text-center">
                                <form id="payment-form" action="{{ route('officialpayments.store') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="user_id" value="{{ $user->user_id }}">
                                    <input type="hidden" name="name" value="{{ $user->fname }} {{$user->lname}}">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">Verification Charges</th>
                                                <td>₹{{ $amount }}</td>
