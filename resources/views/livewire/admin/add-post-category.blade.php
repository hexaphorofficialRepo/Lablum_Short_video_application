            ...
            <div class="bg-blue p-3 m-2 rounded-md">
                ...
                <div class="row">
                    <div class="col-md-6  text-center" style="font-weight: bold; font-size: 20px;">
                        <h3 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-4xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Add New Post Category</span> </h3>
                    </div>
                ...
                <div class="py-3">
                    ...
                    <form wire:submit.prevent="storeOrUpdateCategory" method="post" enctype="multipart/form-data"
