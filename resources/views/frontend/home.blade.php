...
@section('meta_description', 'Laugh, learn & be entertained with Lablums endless stream of short videos! Discover & share funny clips, life hacks & more in a vibrant')
@section('meta_keywords', 'Laugh, learn & be entertained with Lablums endless stream of short videos! Discover & share funny clips, life hacks & more in a vibrant')
...
Lablum - Watch, Share, Earn!
                                <img style= "max-width: 12%;" src="{{asset('frontend/img/icons/pie-icon.webp')}}" alt="pie_chart">
                            </h1>
            ...
            <img class="hero-thumb__icon6 wow zoomIn animated" data-wow-duration="500ms" data-wow-delay="1200ms"
              src="assets/img/icons/hero-icon-6.png" alt="icon"> -->
                            ...
                            <video class="animated-video" style="max-width: 100%;
          max-height: 100%;
          position: relative;
          bottom: 55px;
          width: 317px;
    ...
    ">
                    <div class="col-lg-6 mx-auto mb-35" style="display: flex;justify-content:center;align-items:center">
                        ...
                        <div class="video-container" style="display: flex;justify-content: center;">
                          ...
                          <iframe width="560" height="315" src="https://www.youtube.com/embed/MOPBVQ9_Tu0?si=XzWTO7l-001OxI_b" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="service-block service-block--style2 text-center"style="height:433px">
                            ...
                            <h3 class="service-block__title mb-0 pt-30">
                                ...
                                <p style="color: black; min-height: 84px;">Understand who you're talking to. Know their interests, preferences, and pain points."
                                </p>
                            </h3>
                            <div class="about__button pt-20" style="padding-top:47px">
                                <a href="#" class="btn">Find out More</a>
                    ...
                    <div class="col-lg-3">
                        <div class="service-block service-block--style2 text-center"style="height:433px">
                            ...
                            <h3 class="service-block__title mb-0 pt-30">
                                ...
                                <p style="color: black;min-height: 84px;"> "Focus on creating high-quality content that resonates with your audience."</p>
                            </h3>
                            <div class="about__button pt-20" style="padding-top:47px">
                                <a href="#" class="btn">Find out More</a>
                            </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-5 mb-30">
                                            <div class="featured__content">
                                                ...
                                                <p class="featured__text pt-15">
                                                    Simply creating an account with us is only a few taps and clicks away. Once registered, our users are halfway done and can easily post their short videos, here you can watch videos and earn money.
                                                </p>
                                        ...
                                        <div class="col-lg-7 mb-30">
                                            <div class="featured__img--right wow fadeInRightBig animated"
                                                ...
                                                <img src="{{asset('frontend/img/poster/Profile (1).webp')}}" alt="Featured">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-5 mb-30">
                                            <div class="featured__content">
                                                ...
                                                <p class="featured__text pt-15">
                                                    Lablum provides a variety of content genres including comedy, music, dance, education, and lifestyle. Our platform isn't restricted to any particular genre, so feel free to explore new journeys.
                                                </p>
                                        ...
                                        <div class="col-lg-7 mb-30">
                                            <div class="featured__img--right">
                                                <img src="{{asset('frontend/img/poster/Category 1.1 (1) (1).webp')}}" alt="Featured">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-5 mb-30">
                                            <div class="featured__content">
                                                ...
                                                <p class="featured__text pt-15">
                                                    More than being just a platform, Lablum is a community of like-minded people passionate about their work and digital creativity. We encourage practices such as collaboration, feedback, and interaction amongst our users, thereby instilling a sense of a supportive environment where there's space for everyone. 
                                                </p>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-5 mb-30">
                                            <div class="featured__content">
                                                ...
                                                <p class="featured__text pt-15">
                                                    Lablum specifically rewards its users for engaging in their content. You can now watch video and earn money. With the help of our distinct innovative monetization, users can gather their earnings based on the time they spend on the app watching content. It's literally that simple, the more you watch, the more you earn!
                                                </p>
                                        ...
                                        <div class="col-lg-7 mb-30">
                                            <div class="featured__img--right">
                                                <img src="{{asset('frontend/img/poster/Earning 1.1 (1).webp')}}" alt="Featured">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-5 mb-30">
                                            <div class="featured__content">
                                                ...
                                                <p class="featured__text pt-15">
                                                    Lablum’s digital wallet is a safe and secure way to receive your rewards. No matter where you go, your wallet remains safe with us. 
                                                </p>
                                        ...
                                        <div class="col-lg-7 mb-30">
                                            <div class="featured__img--right">
                                                <img src="{{asset('frontend/img/poster/Wallet (1).0.webp')}}" alt="Featured">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-5 mb-30">
                                            <div class="featured__content">
                                                ...
                                                <p class="featured__text pt-15">
                                                    The Verification Badge from Lablum indicates that your profile has gone through thorough verification. It ensures authenticity and legitimacy. The badge acts as a mark of approval from us about the genuineness of your profile.
                                                </p>
                                        ...
                                        <div class="col-lg-7 mb-30">
                                            <div class="featured__img--right">
                                               <img src="{{asset('frontend/img/poster/Feature Case Study.11.webp')}}" alt="Featured">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <p style="text-align: justify">The Verification Badge signifies that Lablum entertainment private limited has undergone a thorough verification process to confirm our identity and legitimacy. It serves as a stamp of approval from reputable third-party organizations, providing our clients and partners with peace of mind when engaging with us.</p>
                    </div>
    
                    <div class="col-lg-4" style="display: flex;
      justify-content: center;">
                        <img src="{{asset('/frontend/img/about/Verification Badge.1.png')}}" alt="#" style="border-radius: 12px">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 mb-30">
                        <div id="carousel" style="margin-bottom: 0px">
                            <figure id="spinner">
                                <img src="{{asset('/frontend/img/avatar/WhatsApp Image 2024-04-11 at 5.56 1 (1).png')}}" alt="Lablum Entertainment">
                                <img src="{{asset('/frontend/img/avatar/WhatsApp Image 2024-04-11 at 5.56 1 (1).png')}}"  alt="Lablum Entertainment">
                                <img src="{{asset('/frontend/img/avatar/image 38522 (1).png')}}" alt="Lablum Entertainment">
                                <img src="{{asset('/frontend/img/avatar/Frame 24.1 (1).png')}}"  alt="Lablum Entertainment">
                                <img src="{{asset('/frontend/img/avatar/2148161774 1 (2).png')}}"  alt="Lablum Entertainment">
                ...
                <div class="row">
                    <div class="col-lg-5 mb-30">
                        <div class="partner__content">
                            ...
                            <p class="partner__text mb-45">
                                Our platform has been designed for an uninterrupted seamless affair for our creators as well as viewers. The platform provides ample opportunities to not just enjoy the versatile content but also make money simultaneously.
                            </p>
                        ...
                        <div class="row gxy-2">
                            <div class="col-lg-12 col-md-12 wow fadeInUp animated" data-wow-duration="500ms"
                                ...
                                <div class="partner-block" style="background: none">
                                    <img src="{{asset('/assets/images/all-img/Join Our Platform.png')}}" alt="Partner">
                                </div>
                            </div>
      ...
      <div id="signupModal" class="modal">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="signupForm" action="{{ route('frontend.adds.register') }}"
                                                method="POST">
                                                @csrf
                                                <h2>Sign Up</h2>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select type="text" id="business_type"
                                                                name="business_type" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="password" class="form-control"
                                                                    ...
                                                                    id="password-input-con" required>
                                                                <span class="eye-icon-box">
                                                                    <span class="eye-icon">
                                                                        <i class="fas fa-eye"
                                                                            id="toggleCon-password"></i>
                                                                    </span>
                                                                </span>
                                                            </div>
                                                        </div>
