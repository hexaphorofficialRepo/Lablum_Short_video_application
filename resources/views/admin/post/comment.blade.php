                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img id="userImage" height="100px" width="100px" alt="user-profile-pic"
                                                ...
                                                src="{{ asset('storage/profile_pic/' . $comments->user->user_id . '/' . $comments->user->user_dp) }}">
                                        </td>



                                        <td> {{ $comments->user->user_id }}</td>
                                        <td> {{ $comments->user->username }}</td>
                                        <td>{{ $comments->user->fname }} {{ $comments->user->lname }}</td>
                                        {{-- <td>0</td> --}}
                                        <td>{{ $comments->user->mobile }}</td>
                                        <td>{{$comments->comment}}

                                        <td>{{ $comments->created_at->diffForHumans() }}</td>

                                        <td> <a href="{{route('admin.like.post',$post)}}" class="btn btn-primary info-btn"
