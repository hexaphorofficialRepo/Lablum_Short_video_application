                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img id="userImage" height="100px" width="100px" alt="user-profile-pic"
                                                ...
                                                src="{{ asset('storage/profile_pic/' . $wlist->user->user_id . '/' . $wlist->user->user_dp) }}">
                                        </td>



                                        <td> {{ $wlist->user->user_id }}</td>
                                        <td> {{ $wlist->user->username }}</td>
                                        <td>{{ $wlist->user->fname }} {{ $wlist->user->lname }}</td>
                                        {{-- <td>0</td> --}}
                                        <td>{{ $wlist->user->mobile }}</td>

                                        <td>{{ $wlist->created_at->diffForHumans() }}</td>
                                        ...
                                        <td> <a href="{{ route('admin.like.post', $post) }}"
                                                class="btn btn-primary info-btn"
                                                style="background:lightgreen; border-radius: 7px;">
                                                <i class="fas fa-thumbs-up"></i> View Like
                                            </a></td>
