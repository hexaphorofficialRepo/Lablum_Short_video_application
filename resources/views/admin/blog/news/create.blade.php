                ...
                <div class="col-sm-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <h3 class="header-title m-t-0"><small>Add News And Blog </small></h3>
                            <div class="m-t-20">
                                <form class="" id="blogForm" action="{{ route('admin.blog.store') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" name="title"
                                                    placeholder="Blog Title" required value="{{ old('title') }}">
                                                @error('title')
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <select type="text" name="category_id" id="category"
                                                    class="form-control" placeholder="Blog Category" required>
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="thumbnail"
                                                    name="thumbnail" placeholder="Upload Thumbnail Image" required>
                                                <div class="error-message" id="ThumbnailError" style="color: red;">
                                                </div>
                                            </div>
                                            <hr>
                                            <img id="thumbnail-preview" src="#" alt="Thumbnail Preview"
                                                style="display: none; max-width: 150px; height: 150px; border-radius: 50px;">
                                            <hr>
                                        </div>
                                        <script>
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="image1"
                                                    name="images[]" multiple placeholder="Upload Gallery Images" required>
                                                ...
                                                if (files.length > 0) {
                                                    for (let i = 0; i < files.length; i++) {
                                                        ...
                                                        reader.onload = function(e) {
                                                            ...
                                                            img.style.borderRadius = '30px'; // Corrected property name
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="meta_description" name="meta_description" placeholder="Blog Meta Description" required>{{ old('meta_description') }}</textarea>
                                                <div class="error-message" id="metaDescriptionError"
                                                    style="color: red;"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control" id="description" style="height: 200px;"
                                                    placeholder="Write About Blog" >{{ old('description') }}</textarea>
