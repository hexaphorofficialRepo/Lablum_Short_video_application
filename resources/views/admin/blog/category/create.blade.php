                ...
                <div class="col-sm-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Add News And Blog Category</h3>
                        </div>
                        <div class="panel-body">
                           
                                    <h3 class="header-title m-t-0"><small>Add News And Blog Categpory Here </small></h3>
                                    <div class="m-t-20">
                                        <form class="" action="{{route('admin.blog.category.store')}}" enctype="multipart/form-data" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label>News And Blog Category Title</label>
                                                        <input type="text" class="form-control" id="name" name="title"  placeholder="News And Blog Category Title">
