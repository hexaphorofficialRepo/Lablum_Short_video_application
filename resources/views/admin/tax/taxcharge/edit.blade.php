            ...
            <div class="col-sm-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="m-t-20">
                            <form class="" action="{{route('admin.tax.charges.update',$taxcharge)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" id="tax_id" name="tax_id">
                                                ...
                                                @foreach ($taxes as $tax)
                                                    <option value="{{ $tax->id }}" {{ $taxcharge->tax_id == $tax->id ? 'selected' : '' }}>{{ $tax->tax_type }}</option>
                                                @endforeach
                                            </select>
                                            @error('tax_id')
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" id="payment_type" name="payment_type">
                                                ...
                                                <option value="1" {{ $taxcharge->payment_type == 1 ? 'selected' : '' }}>Payment Gateway</option>
                                                <option value="2" {{ $taxcharge->payment_type == 2 ? 'selected' : '' }}>Pay Out</option>
                                            </select>
                                            @error('payment_type')
                                                <div class="error-message" style="color: red;">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" name="payment_for">
                                                ...
                                                <option value="1" {{ $taxcharge->payment_for == 1 ? 'selected' : '' }}>Advertisment</option>
                                                <option value="2" {{ $taxcharge->payment_for == 2 ? 'selected' : '' }}>Official Account Verification</option>
                                                <option value="3" {{ $taxcharge->payment_for == 3 ? 'selected' : '' }}>Content Viewer And Writer</option>
                                            </select>
                                            @error('payment_for')
                                                <div class="error-message" style="color: red;">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="tax_percentage" placeholder="Tax Percentage" value="{{ $taxcharge->tax_percentage }}">
