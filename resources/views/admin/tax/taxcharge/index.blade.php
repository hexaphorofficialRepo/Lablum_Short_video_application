            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title" style="font-size: 30px;"> TAX AND CHARGES</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="add-new-btn" style="padding: 16px;">
                                <a href="{{route('admin.tax.charge.create')}}" class="btn btn-primary" style="border-radius: 7px;"><i
                                        class=""></i>
                                    Add Tax Charges</a>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$taxcharge->tax->tax_type}}</td>
                                    
                                    <td>
                                        @if($taxcharge->payment_type == 1)
                                            Payment Getway
                                        @elseif($taxcharge->payment_type == 2)
                                            Payout
                                        @else
                                    ...
                                    <td>
                                        @if($taxcharge->payment_for == 1)
                                            Advertisment
                                        @elseif($taxcharge->payment_for == 2)
                                            Official Account Verification
                                        @elseif($taxcharge->payment_for == 3)
                                  ...
                                  <td>
                                    {{$taxcharge->tax_percentage}}
                                  </td>
                                 
                                    <td>{{ $taxcharge->created_at->diffForHumans() }}</td>
                                    ...
                                    <td>
                                        <a class="btn btn-primary info-btn" href="{{route('admin.tax.charges.edit',$taxcharge)}}"
