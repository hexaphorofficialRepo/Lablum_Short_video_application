            ...
            <div class="col-sm-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="m-t-20">
                            <form class="" action="{{route('admin.gst.store')}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xs-12">
                                        <div class="form-group ">
                                            <label>Enter GST Percentage</label>
                                                ...
                                                <input type="number" class="form-control" name="tax_percentage" placeholder="Gst Percentage">
