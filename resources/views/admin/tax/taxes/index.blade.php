            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title" style="font-size: 30px;"> Taxes Type</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="add-new-btn" style="padding: 16px;">
                                <a href="{{ route('admin.taxes.type.create') }}" class="btn btn-primary"
                                    style="border-radius: 7px;"><i class=""></i>
                                    Add New Taxes Type</a>
                            ...
                            <tbody>
                                @foreach ($taxes as $tax)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary info-btn" href="{{route('admin.taxes.type.edit',$tax)}}"
