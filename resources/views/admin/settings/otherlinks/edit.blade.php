                ...
                <div class="col-sm-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Update Other Links </h3>
                        </div>
                        <div class="panel-body">
                           
                                    <h3 class="header-title m-t-0"><small>Update Other Links Here </small></h3>
                                    <div class="m-t-20">
                                        <form class="" action="{{route('admin.other_link.update',$otherlink)}}" enctype="multipart/form-data" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label>Name/Title For 3rd Party Application</label>
                                                        <input type="text" class="form-control" id="name" name="name"  value="{{$otherlink->name}}">
                                                ...
                                                <div class="col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="url" name="url" value="{{$otherlink->url}}" >
                                                    </div>
                                                </div>
