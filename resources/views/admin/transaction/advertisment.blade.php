                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p><a href="{{ route('add.transaction.today', ['date' => \Carbon\Carbon::today()->toDateString()]) }}">Today's Transactions</a></p>
                                ...
                                <tbody>
                                    @foreach ($payments as $payment)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary info-btn" href="{{ route('plan.show',['advertiserId'=>$payment->advertiser_id]) }}"
