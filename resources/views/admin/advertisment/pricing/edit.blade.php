                ...
                <div class="col-sm-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="m-t-20">
                                <form class="" action="{{route('admin.add.pricing.update',$pricing)}}"
                                    enctype="multipart/form-data" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label>Video Count  <span
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label>Types Of Advertisement  <span style="color: red">*</span></label>
                                                <select class="form-control" id="to" name="category">
                                                    <option value="">Select Add Type</option>
                                                    @foreach($addcategories as $category)
                                                        <option value="{{$category->id}}" @if($category->id == $pricing->category) selected @endif> {{$category->title}}</option>
                                                    @endforeach
                                                </select>
                                                @error('category')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="{{$pricing->price}}" name="price" id="viewer_points" class="form-control @error('price') is-invalid @enderror" placeholder="Pricing For Add Video" value="{{ old('price') }}" required>
                                                </div>
                                                @error('price')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
