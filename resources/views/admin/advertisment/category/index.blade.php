            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title" style="font-size: 30px;"> News And Blog Category List </h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="add-new-btn" style="padding: 16px;">
                                <a href="{{ route('admin.create.add.category') }}" class="btn btn-primary"
                                    style="border-radius: 7px;"><i class=""></i>
                                    Add Advertisment Category </a>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary info-btn" href="{{route('admin.edit.add.category', ['slug' => $category->slug])}}"
