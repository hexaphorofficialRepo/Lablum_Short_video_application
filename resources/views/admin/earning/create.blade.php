                ...
                <div class="col-sm-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="m-t-20">
                                <form class="" action="{{route('admin.store.earning')}}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="form" name="from"
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="creator_points" id="creator_points" class="form-control @error('creator_points') is-invalid @enderror" placeholder="Enter Contain writer Amount Per Video" value="{{ old('creator_points') }}" required>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="viewer_points" id="viewer_points" class="form-control @error('viewer_points') is-invalid @enderror" placeholder="Enter Viewer Amount Per Video" value="{{ old('viewer_points') }}" required>
                                                </div>
                                                @error('viewer_points')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
